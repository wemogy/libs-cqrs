...
{
    public abstract class GetEntityQueryHandler<TDatabaseRepository, TEntity, TPartitionKey, TQuery>
        : GetEntityQueryHandler<TDatabaseRepository, TEntity, TPartitionKey, Guid, TQuery>
